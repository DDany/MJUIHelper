...
@interface MJAlertView : UIAlertView

typedef void(^MJAlertViewButtonHandler)(MJAlertView* alert, NSInteger buttonIndex);
@property (nonatomic, copy) MJAlertViewButtonHandler buttonHandler;
