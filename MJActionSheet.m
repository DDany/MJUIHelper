...
#import "MJActionSheet.h"

@interface MJActionSheet () <UIActionSheetDelegate>
@end

@implementation MJActionSheet
...
{
	MJActionSheet* sheet = [[self alloc] initWithTitle:title
    ...
    timeoutMessageFormat:(NSString*)countDownMessageFormat
{
    ...
    MJActionSheetButtonHandler finalHandler = [self.buttonHandler copy];
    self.buttonHandler = ^(MJActionSheet* bhSheet, NSInteger bhButtonIndex) {
