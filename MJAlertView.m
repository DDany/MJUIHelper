...
@interface MJAlertView () <UIAlertViewDelegate>
...
+ (void)showAlertWithTitle:(NSString *)title message:(NSString *)message
            ...
            onButtonTapped:(MJAlertViewButtonHandler)handler
{
	MJAlertView* alert = [[self alloc] initWithTitle:title message:message
...
+ (void)showAlertWithTitle:(NSString *)title message:(NSString *)message
            ...
            onButtonTapped:(void(^)(MJAlertView* alert, NSInteger buttonIndex))handler
{
   ...
   timeoutMessageFormat:(NSString*)countDownMessageFormat
{
    ...
    MJAlertViewButtonHandler finalHandler = [self.buttonHandler copy];
    self.buttonHandler = ^(MJAlertView* bhAlert, NSInteger bhButtonIndex) {
